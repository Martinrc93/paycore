...
- Reservations, captures, releases, or expirations for merchant payments.
- Payment commands or payment authorization workflows.
- Administrative HTTP APIs for wallet lifecycle, reconciliation, or rebuild.
- A financial posting or money-movement caller for incoming-credit activation; this change defines the application boundary only.
